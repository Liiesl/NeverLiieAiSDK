...
class AnthropicCompatible(BaseProvider):
    """Generic Anthropic-compatible provider for custom API endpoints.
    
    Supports any API that follows the Anthropic Messages API format including:
    - Amazon Bedrock (with proxy)
    ...
    def get_models(self) -> ModelsResponse:
        ...
        for model in models_data:
            normalized_data.append({
                ...
                "owned_by": self.default_owned_by,
